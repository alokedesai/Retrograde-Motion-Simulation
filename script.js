function deg2rad(d) {
		...
		Gear.prototype.render = function (context, drawCircle) {
		    ...
		    for (var i = 0; i < this.teeth * 2; i++) {
		        ...
		        // lable one tooth as red
		        if (i == 0 && drawCircle) {
		        	currentContext = this.fillStyle;
		        	context.fillStyle = "red";
		        	context.fill();
		        	context.fillStyle = currentContext;

		        	context.beginPath();
							context.moveTo(x, y);
							context.lineTo(gear2X, gear2Y);
		        }
		    }
		    context.fill();
		    context.stroke();
		...
		var gear = new Gear(W / 2, H / 2, 10, 15, "white", "rgba(61, 142, 198, 1)");
		...
		setInterval(function () {
		    ...
		    gear.render(context, false);
		    gear2.render(context, true);
		}, 20);
